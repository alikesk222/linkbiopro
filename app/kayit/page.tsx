      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <p className="text-slate-400">Ücretsiz, kredi kartı gerekmez.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1.5">
                Kullanıcı Adı
                <span className="text-slate-500 font-normal ml-2">linkbio.pro/<span className="text-indigo-400">{form.username || 'siz'}</span></span>
              </label>
              <input
                type="text"
                value={form.username}
                ...
                className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 transition-all"
              />
              <p className="text-xs text-slate-600 mt-1">Sadece harf, rakam ve alt çizgi (3-20 karakter)</p>
            </div>
            ...
            <p className="text-center text-sm text-slate-500">
              ...
              <Link href="/giris" className="text-indigo-400 hover:text-white transition-colors">
                Giriş Yap
              </Link>
            </p>
          </form>
